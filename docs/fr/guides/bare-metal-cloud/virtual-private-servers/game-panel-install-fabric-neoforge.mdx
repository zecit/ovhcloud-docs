...
description: Installez Fabric ou NeoForge sur votre serveur Minecraft via le Game Panel pour exécuter des contenus moddés avec des chargeurs de mods personnalisés.
...
- Le SFTP activé sur votre serveur. Consultez le guide [Activer le SFTP sur le Game Panel](/guides/bare-metal-cloud/virtual-private-servers/game-panel-enable-sftp/).
...
1. Rendez-vous dans les <code className="action">Settings</code> de votre serveur.
2. Ouvrez l'onglet <code className="action">Game Config</code>.
...
- [Installer un serveur PaperMC et ajouter des plugins sur le Game Panel](/guides/bare-metal-cloud/virtual-private-servers/game-panel-install-papermc/)
