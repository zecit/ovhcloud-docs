...
description: Install Fabric or NeoForge on your Minecraft server via the Game Panel to run modded content with custom mod loaders.
...
1. Go to your server <code className="action">Settings</code>.
2. Open the <code className="action">Game Config</code> tab.
...
- [Install a PaperMC server and add plugins on the Game Panel](/guides/bare-metal-cloud/virtual-private-servers/game-panel-install-papermc/)
